...
def createTab(page):
    ...
    tabHelpFrame = ttk.Labelframe(aboutTab, text=' Aditional Information: ', takefocus = 0)
    ...
    aboutFile = os.path.realpath(os.path.join(os.path.dirname(__file__), 'assets/SLCB_SendSounds_about.txt'))
    try:
    ...
    fn.printLog(msg)
    tabHelpText.config(state='disabled', selectbackground=theme.darkGray, selectforeground=theme.darkWhite, cursor='arrow')
